[README.md](https://github.com/user-attachments/files/28334272/README.1.md)
...
This code implements a simplified simulation framework for a single-UAV-assisted IoT data collection system. It compares a straight-line and equal-time baseline with a fairness-aware trajectory-and-time-allocation heuristic.
...
This code supports the experiments, tables, and figures reported in Chapter 4 of the thesis.

The code is intended to make the thesis results reproducible, including the baseline method, ablation study, combined proposed method, and multi-scenario experiments.
